...
extern UINT8                   g_priority_ready_tracker[4][2];
extern struct s_pcb 	       *g_current_process;
extern UINT32 					g_asmBridge;                       //Used as a temp variable to get contents of address and data registers into C structs.
